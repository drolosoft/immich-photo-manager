...
- **Live, every tool, two Immich versions**: [`tests/live/`](tests/live/) starts real Immich **2.7.5** and **3.1.0** in Docker, fills them with a small library, and drives all 59 tools over the MCP protocol, re-reading state after each write. Run before every release; last full run 2026-09-01, 89/89 checks on both.
...
| **[MCP Tools Reference](doc/MCP-TOOLS.md)** | All 59 MCP tools — parameters, return types, examples |
